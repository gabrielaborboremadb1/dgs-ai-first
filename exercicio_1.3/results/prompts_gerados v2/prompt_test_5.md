...
Relevância : 0.7164
Conteúdo   :
PROC-042, 4. Condições especiais: [PROC-042] Procedimento de Cálculo de Frete Especial — 4. Condições especiais
...
Documento  : PROC-042-v2 — Procedimento de Cálculo de Frete Especial (Revisado)
Versão     : 2.0
Seção      : 2. Fórmula de cálculo
Extraído em: 09/06/2026
Relevância : 0.7620
Conteúdo   :
PROC-042-v2, 2. Fórmula de cálculo: [PROC-042-v2] Procedimento de Cálculo de Frete Especial (Revisado) — 2. Fórmula de cálculo
