...
Relevância : 0.7792
Conteúdo   :
PROC-042-v2, 1. Objetivo: [PROC-042-v2] Procedimento de Cálculo de Frete Especial (Revisado) — 1. Objetivo
...
Documento  : PROC-042-v2 — Procedimento de Cálculo de Frete Especial (Revisado)
Versão     : 2.0
Seção      : 5. Disposições transitórias
Extraído em: 09/06/2026
Relevância : 0.7330
Conteúdo   :
PROC-042-v2, 5. Disposições transitórias: [PROC-042-v2] Procedimento de Cálculo de Frete Especial (Revisado) — 5. Disposições transitórias
